...
class TestModifierAgent(BaseAgent):
    """
    Specialized Tier: Write-only test creation and modification.
    
    This agent handles write-only test operations.
    ...
    def __init__(self):
        super().__init__(
            name="TestModifierAgent",
            description="Creates and modifies test files and test cases."
        )
